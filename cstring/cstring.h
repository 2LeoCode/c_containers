...
/*   Updated: 2022/11/09 19:26:08 by Leo Suardi       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int cstring_compare_raw_n( const_cstring * self, const char * other, size_t len );
...
bool cstring_starts_with_raw_n( const_cstring * self, const char * other, size_t len );
...
bool cstring_ends_with_raw_n( const_cstring * self, const char * other, size_t len );
...
bool cstring_contains_raw_n( const_cstring * self, const char * other, size_t len );
...
ptrdiff_t cstring_find_raw_n( const_cstring * self, const char * other, size_t len, ptrdiff_t pos );
...
ptrdiff_t cstring_rfind_raw_n( const_cstring * self, const char * other, size_t len, ptrdiff_t pos );
...
ptrdiff_t cstring_find_first_of_raw_n( const_cstring * self, const char * other, size_t len, ptrdiff_t pos );
...
ptrdiff_t cstring_find_last_of_raw_n( const_cstring self, const char * other, size_t len, ptrdiff_t pos );
...
ptrdiff_t cstring_find_first_not_of_raw_n( const_cstring self, const char * other, size_t len, ptrdiff_t pos );
...
ptrdiff_t cstring_find_last_not_of_raw_n( const_cstring self, const char * other, size_t len, ptrdiff_t pos );

table(cstring) cstring_split( const_cstring self, const_cstring delim, ptrdiff_t * pos );
table(cstring) cstring_split_raw( const_cstring self, const char * delim, ptrdiff_t * pos );
table(cstring) cstring_split_raw_n( const_cstring self, const char * delim, size_t len, ptrdiff_t * pos );

cstring * cstring_split_lines( const_cstring self, ptrdiff_t * pos );
...
cstring cstring_join_raw_n( const_cstring * strings, size_t n, const char * delim, size_t len );
